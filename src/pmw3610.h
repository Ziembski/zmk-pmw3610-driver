...
#if defined(CONFIG_PMW3610_INO_POLLING_RATE_250) || defined(CONFIG_PMW3610_INO_POLLING_RATE_125_SW)
#define PMW3610_POLLING_RATE_VALUE 0x0D
#elif defined(CONFIG_PMW3610_INO_POLLING_RATE_125)
#define PMW3610_POLLING_RATE_VALUE 0x00
#else
#error "A valid PMW3610 polling rate must be selected"
#endif

#ifdef CONFIG_PMW3610_INO_FORCE_AWAKE
...
#ifdef CONFIG_PMW3610_INO_INVERT_SCROLL_X
...
#ifdef CONFIG_PMW3610_INO_INVERT_SCROLL_Y
